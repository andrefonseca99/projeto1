...
class SneakerDetailViewTest(SneakerTestBase):
    ...
    def test_sneaker_detail_view_function_is_correct(self):
        view = resolve(reverse('sneakers:sneaker', kwargs={'pk': 1000}))
        self.assertIs(view.func.view_class, views.SneakerDetailView)

    def test_sneaker_detail_view_return_404_if_no_sneakers_found(self):
        response = self.client.get(reverse('sneakers:sneaker', kwargs={'pk': 1000}))  # noqa: E501
    ...
    def test_sneaker_detail_template_loads_the_correct_sneaker(self):
        ...
        response = self.client.get(reverse('sneakers:sneaker', kwargs={'pk': 1}))  # noqa: E501
    ...
    def test_sneaker_detail_template_dont_load_sneaker_not_published(self):
        ...
        response = self.client.get(reverse('sneakers:sneaker', kwargs={'pk': sneaker.id}))  # noqa: E501
